namespace LASYS.Domain.Product
{
    public class ProductMaster
    {
        ...
        public string? UbReportTypeCode { get; set; }
        public string? CbReportTypeCode { get; set; }
        ...
        // Additional barcode / UDI / packaging variants
        public string? UbBarcode { get; set; }
        public string? CbBarcode { get; set; }
        public string? Udi { get; set; }
        public string? CheckDigit { get; set; }
        public string? Roche { get; set; }
        public DateTime? UdiDate { get; set; }

        public int? OcbQuantity { get; set; }
        public string? OcbBarcode { get; set; }
        ...
        public string? OubBarcode { get; set; }
        ...
        public string? AubBarcode { get; set; }
        ...
        public string? AcbBarcode { get; set; }
