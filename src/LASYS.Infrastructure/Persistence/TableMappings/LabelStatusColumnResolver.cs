...
{
    public sealed class LabelStatusColumnResolver : ILabelStatusColumnResolver
    {
        public string GetLabelStatusColumnName(BoxType boxType)
        {
